...
// ============================================
// 模板工厂（保留给 user 维度 workbench）
// 2026-09-08：代理商业务砍掉后只留 createTestPromptTemplate，
// createTestAgent / assignTemplatesToAgent / cleanupTestAgents 全部删除。
// ============================================
...
export async function createTestPromptTemplate(
  ...
  const data: schema.NewPromptTemplate = {
    ...
    variables: [],
    // 2026-09-11：精简后 promptTemplate 默认模型切到 qwen。
    model: "qwen",
    price: options.price ?? 0,
