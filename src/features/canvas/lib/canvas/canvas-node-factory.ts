...
import { nodeSizeFromRatio } from "@/features/canvas/lib/canvas/canvas-node-size";
import type { UploadedFile } from "@/features/canvas/services/file-storage";
import type { UploadedImage } from "@/features/canvas/services/image-storage";
...
export function buildAudioGenerationMetadata(
  config: AiConfig
): CanvasNodeMetadata {
  return {
    model: config.model,
