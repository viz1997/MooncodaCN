...
//
// VITE_ANALYTICS_*_ID 走 env-shim —— 直接读 import.meta.env 在 Next.js 16 Turbopack dev 下
// 抛 "Cannot read properties of undefined (reading 'VITE_ANALYTICS_GA4_ID')"
import {
  VITE_ANALYTICS_BAIDU_ID,
  VITE_ANALYTICS_GA4_ID,
...
function read(
  ...
  if (typeof buildTime === "string" && buildTime.trim())
    return buildTime.trim();
  return fallback;
}

export const ANALYTICS_GA4_ID = read("ANALYTICS_GA4_ID", VITE_ANALYTICS_GA4_ID);
