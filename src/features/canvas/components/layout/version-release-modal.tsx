...
import { useVersionCheck } from "@/features/canvas/hooks/use-version-check";
    ...
    <>
      ...
      >
        <span className="relative inline-flex">
          {currentVersion}
          {hasNewVersion ? (
            <span className="absolute -right-1.5 -top-1 size-1.5 rounded-full bg-green-500" />
          ) : null}
        </span>
      </button>
      <Modal
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="flex min-w-0 items-center gap-1.5">
                      {release.version === latestVersion ? (
                        <Tag color="green">{t("version.latest")}</Tag>
                      ) : null}
                      {release.version === currentVersion ? (
                        <Tag>{t("version.current")}</Tag>
                      ) : null}
                    </div>
                  </div>
                    ...
                    {release.items.map((item, index) => (
                      ...
                      >
                        <Tag
                          ...
                          className="m-0 mt-0.5 shrink-0 whitespace-nowrap"
                        >
