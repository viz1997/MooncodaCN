...
export function CanvasNodeAngleDialog({
  ...
  const update = <Key extends keyof CanvasImageAngleParams>(
    key: Key,
    value: CanvasImageAngleParams[Key]
      ...
      <div className="space-y-5">
        <div>
          <h2 className="text-xl font-semibold">
            {t("canvas.editors.angleTitle")}
          </h2>
          <p className="mt-1 text-sm opacity-60">
            {t("canvas.editors.angleDescription")}
          </p>
        </div>
        <div className="grid gap-6 md:grid-cols-[minmax(260px,1fr)_360px]">
            ...
            <div className="grid flex-1 place-items-center">
              <div className="relative">
                <img
                  ...
                  draggable={false}
                  style={{ transform: previewTransform(params) }}
                />
          ...
          <div className="space-y-6 py-2">
            <AngleSlider
              label={t("canvas.editors.horizontal")}
            ...
            />
            <AngleSlider
              label={t("canvas.editors.distance")}
