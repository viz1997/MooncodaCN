  ...
  return (
    <ImageSettingsTheme theme={theme}>
      ...
      >
        ...
        <SettingGroup
          title={t("settingsPanels.audio.voice")}
        ...
        <SettingGroup
          title={t("settingsPanels.audio.format")}
          color={theme.node.muted}
        >
          <div className="grid grid-cols-3 gap-2.5">
        ...
        <SettingGroup
          title={t("settingsPanels.audio.speed")}
          color={theme.node.muted}
        >
          ...
          <input
            ...
            onChange={(event) =>
              onConfigChange("audioSpeed", event.target.value)
            }
            onBlur={(event) =>
              onConfigChange(
                "audioSpeed",
        ...
        <SettingGroup
          title={t("settingsPanels.audio.instructions")}
          color={theme.node.muted}
        >
          <textarea
            ...
            onChange={(event) =>
              onConfigChange("audioInstructions", event.target.value)
            }
            onMouseDown={(event) => event.stopPropagation()}
          />
        </SettingGroup>
