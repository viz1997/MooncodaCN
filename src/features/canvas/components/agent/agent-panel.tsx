...
import {
  ...
  useAgentStore,
} from "@/features/canvas/stores/use-agent-store";
...
export function AgentPanel() {
  ...
  return (
    <motion.div
      ...
      style={{
        overflow: "clip",
        pointerEvents: panelOpen && !panelClosing ? undefined : "none",
      }}
    >
      <motion.aside
      ...
      >
        <button
          type="button"
          className="absolute inset-y-0 left-0 z-40 w-4 -translate-x-1/2 cursor-col-resize"
